...
public class GrapheTerrain {
	...
	public double getLongueurSommet(int id){
		return getSommet(id).getL();
	}
	...
	public void setHopitaux(List<Integer> hopitaux) {
	...
	public boolean isVictime(int position){
		return victimes.contains(position);
	}
	
	public boolean isHopital(int position){
		return hopitaux.contains(position);
	}
	
	public void sauverVictime(int postion){
		victimes.remove(Integer.valueOf(postion));
	}
...
//		System.out.println();
		...
		res.add(Integer.valueOf((int)distance[arrivee]+intersection.size()));
		return res;
	}
	
	public static GrapheTerrain initGraphe1(){
	...
	public static GrapheTerrain initGraphe2(){
		int N = 12;//Nombre de sommet
		
		//Création du Graphe.
		GrapheTerrain graphe = new GrapheTerrain();
		//Graphe - Ajouts des Sommets.
		Sommet A = new Sommet(0,5);
		graphe.getGraphe().add(A);
		Sommet B = new Sommet(1,1);
		graphe.getGraphe().add(B);
		Sommet C = new Sommet(2,0.5);
		graphe.getGraphe().add(C);
		Sommet D = new Sommet(3,0.5);
		graphe.getGraphe().add(D);
		Sommet E = new Sommet(4,0.5);
		graphe.getGraphe().add(E);
		Sommet F = new Sommet(5,0.5);
		graphe.getGraphe().add(F);
		Sommet G = new Sommet(6,0.5);
		graphe.getGraphe().add(G);
		Sommet H = new Sommet(7,1);
		graphe.getGraphe().add(H);
		Sommet I = new Sommet(8,1);
		graphe.getGraphe().add(I);
		Sommet J = new Sommet(9,2);
		graphe.getGraphe().add(J);
		Sommet K = new Sommet(10,1);
		graphe.getGraphe().add(K);
		Sommet L = new Sommet(11,0.5);
		graphe.getGraphe().add(L);
		//Graphe - Ajout des Arcs.	
		boolean aGauche = true;
		boolean aDroite = false;
		graphe.addArc(0, 1, aDroite,0);
        graphe.addArc(0, 2, aGauche,0);
        graphe.addArc(0, 5, aGauche,4);
        graphe.addArc(0, 9, aDroite,4);

        graphe.addArc(1, 2, aDroite,0);
        graphe.addArc(1, 3, aGauche,2);
        graphe.addArc(1, 4, aDroite,2);
        
        graphe.addArc(3, 2, aGauche,1);
        
        graphe.addArc(4, 3, aDroite,2);
        graphe.addArc(4, 5, aDroite,3);
        graphe.addArc(4, 8, aGauche,3);
        
        graphe.addArc(6, 2, aDroite,1);
        graphe.addArc(6, 3, aGauche,1);
        graphe.addArc(6, 7, aDroite,5);
        graphe.addArc(6, 10, aGauche,5);
        
        graphe.addArc(7, 10, aDroite,5);
        graphe.addArc(7, 10, aGauche,6);
        graphe.addArc(7, 11, aDroite ,6);
        
        graphe.addArc(8, 5, aGauche,3);
        graphe.addArc(8, 9, aDroite,7);
        graphe.addArc(8, 11, aGauche,7);
        
        graphe.addArc(9, 5, aDroite,4);
        graphe.addArc(9, 11, aDroite,7);
        
        graphe.addArc(11, 10, aDroite,6);
        return graphe;
	}
